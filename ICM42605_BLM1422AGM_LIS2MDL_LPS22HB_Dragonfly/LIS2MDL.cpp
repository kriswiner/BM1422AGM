...
void LIS2MDL::offsetBias(float * dest1, float * dest2)
{
  ...
  Serial.println("Calculate LIS2MDL mag offset bias: move all around to sample the complete response surface!");
  delay(4000);
  ...
  _mRes = 0.0015f; // fixed sensitivity
   ...
   Serial.println("LIS2MDL mag Calibration done!");
}
...
void LIS2MDL::selfTest()
{
  ...
  Serial.println("LIS2MDL Mag Self Test:");
